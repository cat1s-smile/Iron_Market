		...
		<div class="upper-container">
			...
			<ul class="entities">
				<li class="menu-elem">
					...
					<input id= "a-products" class="button-menu" type="button" onclick="window.location.href = '/Iron_Market_war/admin-products';" value="Товары">
				</li>
				<li class="menu-elem">
					<%--					<a href='<c:url value="/admin-categories" />' type="button">Категории</a>--%>
					<input id= "a-categories" class="button-menu" type="button" onclick="window.location.href = '/Iron_Market_war/admin-categories';" value="Категории" style="background-color: #1220a7">
				</li>
				<li class="menu-elem">
