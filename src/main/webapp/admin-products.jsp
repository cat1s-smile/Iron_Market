...
<%--					<a href='<c:url value="/admin-products" />' type="button">Товары</a>--%>
					<input id= "a-products" class="button-menu" type="button" onclick="window.location.href = '/Iron_Market_war/admin-products';" value="Товары" style="background-color: #1220a7">
				</li>
				<li class="menu-elem">
<%--					<a href='<c:url value="/admin-categories" />' type="button">Категории</a>--%>
					<input id= "a-categories" class="button-menu" type="button" onclick="window.location.href = '/Iron_Market_war/admin-categories';" value="Категории">
				</li>
				<li class="menu-elem">
<%--					<a href='<c:url value="/admin-orders" />' type="button">Заказы</a>--%>
					<input id= "a-orders" class="button-menu" type="button" onclick="window.location.href = '/Iron_Market_war/admin-orders';" value="Заказы">
				</li>
			</ul>
		</div>
	</header>
		...
		<div class="container-table">
			<table class="table-product">
				<tr>
					...
					<th style="width: 10px">ID Категории</th>
